...
<!DOCTYPE html>
<html>
<% ArrayList <Event> eventList = (ArrayList) request.getAttribute("eventList"); %>
<head>
				...
				<%int count = 1;
				  for(Event event : eventList ){ %>
					<tr>
						...
						<td><%=count++%></td>
						<td><img height="200px" width="150px" src="data:image/jpeg;base64,<%=event.getEventString() %>"></td>
						...
						<td>			
							...
							<a data-id="<%=event.getEventId() %>" href="#deleteEventModal" class="delete event-delete-button" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
					<%} %>
		...
		<div class="modal-content">
			<form>
				...
				<div class="modal-footer">
					...
					<a id="deleteEventModalId" href="#" type="button" class="btn btn-danger">Delete</a>
				</div>
			</form>
		</div>
	</div>
...
$(document).on("click", ".event-delete-button", function () {
	
    var myBookId = $(this).data('id');
    $("#deleteEventModal #deleteEventModalId").attr("href",'RemoveEventServlet?eventId=' +myBookId);
