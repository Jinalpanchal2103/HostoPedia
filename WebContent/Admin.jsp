...
<!--           <li class="dropdown"><a href="#"><span>Sign up</span> <i class="bi bi-chevron-down"></i></a>
          ...
          <li><a class="nav-link scrollto active" href="DisplayAlUserDetails">Manage Users</a></li>
           <li class="dropdown"><a href="#"><span>Manage Hostel Details</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
          ...
          <li class="dropdown"><a href="#"><span>Manage Food</span> <i class="bi bi-chevron-down"></i></a>
           ...
           <li><a class="nav-link scrollto active" href="DisplayComplaintToAdmin">View Complaint</a></li> 
...
<!--             </ul> -->
<!--           </li> -->
				<li><a href="DisplayBookingServletToAdmin">View Bookings</a></li>
          <li><a href="DisplayFeedbackToAdmin">View Feedbacks</a></li>
<!--           <li><a class="nav-link scrollto active" href="DisplayRoomAllocationServlet">RoomAllocatate</a></li> -->
           <li><a class="nav-link scrollto active" href="Generate Report.jsp">Generate Report</a></li>
