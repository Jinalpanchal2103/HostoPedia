...
<%@page import="com.HostoPedia.bean.Feedback"%>
		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addFeedbackModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Feedback</span></a>
				...
				<%int count = 1;
				  for(Feedback feedback : feedbackList ){ %>
					<tr>
						...
						<td><%=count++%></td>
						<td><%=feedback.getFeedbackRating()%></td>
...
<%-- 						<a href="EditEventServlet?eventId=<%=event.getEventId() %>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a> --%>
							<a data-id="<%=feedback.getFeedbackId() %>" href="#deleteFeedbackModal" class="delete feedback-delete-button" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
					<%} %>
