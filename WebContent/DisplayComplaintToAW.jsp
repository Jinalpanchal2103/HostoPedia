...
<%@page import="com.HostoPedia.bean.Complaint"%>
<%@page import="com.HostoPedia.bean.User"%>
<%@page import="java.util.List"%>
<!DOCTYPE html>
<html>
<%List<Complaint> complaintList=(List)request.getAttribute("complaintList"); %>
<head>
				...
				<%int count = 1;
				  for(Complaint complaint : complaintList ){ %>
					<tr>
						...
						<td><%=count++%></td>
						<td><%=complaint.getComptName()%></td>
						<td><%=complaint.getComptDescription()%></td>
						<td><%=complaint.getComptDate()%></td>
...
<%-- 						<a href="EditEventServlet?eventId=<%=event.getEventId() %>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a> --%>
							<a data-id="<%=complaint.getComptId() %>" href="#deleteFeedbackModal" class="delete feedback-delete-button" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
					<%} %>
