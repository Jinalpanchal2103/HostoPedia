...
<!-- 		      	<h5 class="mb-4 text-center">Please provide your feedback below: </h5> -->
		      	<form action="FeedbackServlet" method="post" class="signin-form">
...
<!--             				<div class="text-center"> -->
               			<h6>Comments:</h6>
               			 <div class="form-group">
               				<textarea style="background: #5c341c;font-color: black;" class="form-control" name="comment" placeholder="Your Comment" rows="2"></textarea>
               			 </div>
	            		<div class="form-group">
                        	<button type="submit" style="position:relative;width:100px;margin-left:50px" class="form-control btn btn-primary submit px-3" value="Submit" class="submit" id="submit" name="submit">Send</button>
